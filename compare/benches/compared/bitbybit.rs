use arbitrary_int::{u4, u5, u12, u20};
...
pub fn set_jep106(lpi: &mut GicRedistributorLpi, value: u16) {
    lpi.implementer_identification = lpi.implementer_identification.with_implementer_jep106(u12::new(value));
}
...
pub fn combined(input: Input) -> (u32, u32, u64, bool, u12, u16, CommonLpiAffinity) {
    ...
    (
        lpi.control.raw_value(),
        lpi.implementer_identification.raw_value(),
        lpi.redistributor_type.raw_value(),
        clear,
        jep106,
        processor_number,
        affinity,
