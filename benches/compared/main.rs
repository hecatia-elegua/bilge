...
pub fn bitfields_compared(c: &mut Criterion) {
    ...
    #[rustfmt::skip]
    group.bench_with_input(BenchmarkId::new("bilge", "input1"), &input1, |b, i| {
        b.iter(|| crate::bilge::bilge(*i))
    });
    group.bench_with_input(BenchmarkId::new("bitbybit", "input1"), &input1, |b, i| {
        b.iter(|| crate::bitbybit::bitbybit(*i))
    });
    group.bench_with_input(BenchmarkId::new("modular", "input1"), &input1, |b, i| {
        b.iter(|| crate::modular::modular(*i))
    });
    group.bench_with_input(BenchmarkId::new("handmade", "input1"), &input1, |b, i| {
        b.iter(|| crate::handmade::handmade(*i))
    });
